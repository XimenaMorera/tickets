...
<div class="container">
    <h1>Editar Ticket</h1>
    <form method="POST" action="{{ route('soporte.update', ['ticket' => $ticket->id]) }}">
        @method('PUT')
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $ticket->title) }}" placeholder="Escribe el título del ticket" disabled="disabled" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="created_by" name="created_by" disabled="disabled" required>
        ...
        <div class="mt-3">
            ...
            <a href="{{ route('soporte.index') }}" class="btn btn-warning">Cancelar</a>
        </div>
    </form>
